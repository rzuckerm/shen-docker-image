SHEN_VERSION := $(shell cat SHEN_VERSION)
SHEN_DEPS := $(wildcard SHEN_*)
DOCKER_TAG_PREFIX := rzuckerm/shen:$(SHEN_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(SHEN_DEPS)
